...
<div class="row">
    ...
    <div class="card col-md-4">
        ...
        <div class="flex gap-4 flex-col items-center justify-center">
            ...
            <h2>{{ $temp ?? '' }}</h2>
            <form class="flex flex-col gap-3 text-lg" method="POST"  action="{{ route('registationfrom') }}" enctype="multipart/form-data">
            ...
            {{ csrf_field() }}
                ...
                <div class="flex justify-center">
                    <input class="border-2" type="submit" value="SignUp">
                </div>
            </form>
        </div>
